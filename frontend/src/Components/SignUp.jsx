...
const SignUp = () => {
  ...
  console.log("🚀 ~ file: Login.jsx:15 ~ Login ~ error:", error);
  console.log("🚀 ~ file: Login.jsx:15 ~ Login ~ data:", data);
  ...
  return (
    <div className="h-[100vh] w-[100vw] grid items-center justify-center">
